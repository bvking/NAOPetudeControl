...
float[] oldVirtualPosition =new float[networkSize];
float[] VirtualPosition  = new float[networkSize];
...
float[] ActualVirtualPosition  = new float[networkSize];;
float[] ActualVirtualPositionFromOtherMode  = new float[networkSize];
float[] oldActualVirtualPosition  = new float[networkSize];
 ...
 // String SPEED = speedi[5]+","+speedi[4]+","+speedi[3]+","+speedi[2]+","+speedi[1]+","+speedi[0]+","; // speedi[11]+","+speedi[10]+","+speedi[9]+","+ speedi[8]+","+speedi[7]+","+ speedi[6]+","+
  ...
  if (formerKeyMetro == '$') {
    ...
    for (int i = 0; i < networkSize; i++) {
      ...
      DataToDueCircularVirtualPosition[i]= (int) map ( DataToDueCircularVirtualPosition[i], -800, 800, 1600, 4800);  // mapped for 6400 step/round +800
