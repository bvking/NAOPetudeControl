/* autogenerated by Processing revision 1286 on 2023-03-23 */
...
public class NAOPetude extends PApplet {
 ...
 //} //ENDFORMERSARTKEYJ
  ...
  if (key == 'R') {
    ...
    for (int i = 0; i < networkSize; i++) {
      ...
      net.phase[i] +=(oscillatorBlocked-i)*0.1f; // oscillator 10 do not nove
...
//   key = 'q' ;  // propagation in on the same way
  ...
  */
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "NAOPetude" };
    if (passedArgs != null) {
