/* autogenerated by Processing revision 1292 on 2023-03-15 */
...
public void setup() {
 ...
 //  lines = loadStrings("vierge.txt");
  ...
  //*************** WITH TEENSY connected
    teensyport = new Serial(this, ports[0], 115200);// si port non connecte
...
oscillatorBlocked=2;
   //    net.phase[i] +=(oscillatorBlocked-i)*0.1; // oscillator 10 do not nove
            net.phase[i] +=(5-i)*0.1f; // oscillator 10 do not nove
     //** */   net.phase[i] +=(networkSize-oscillatorBlocked-i)*0.05;
